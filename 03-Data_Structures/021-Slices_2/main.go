...
func main() {
	...
	var data []string
	// This will create an array at full length so there will be no capacity increase.
	// data := make([]string, 0, 1e5)
	// This will be a bug with append
	// data := make([]string, 1e5) and will produce weird results

	// Capture the capacity of the slice.
	lastCap := cap(data)

	// To gain efficiency without using append
